...
const (
	X_scalegray_EMAIL       = "X-scalegray-EMAIL"
	X_scalegray_APIKEY      = "X-scalegray-APIKEY"
	X_scalegray_DATE        = "X-scalegray-DATE"
	X_scalegray_HMAC        = "X-scalegray-HMAC"
	API_GATEWAY_VERSION = "/v1"
	Content_Type               = "Content-Type"
	application_json           = "application/json"
	Accept                     = "Accept"
	application_vnd_scalegray_json = "application/vnd.scalegray+json"
)
...
func (authly *Authly) AuthHeader() error {
	...
	headMap[X_scalegray_DATE] = authly.Date
	headMap[X_scalegray_EMAIL] = authly.Email
	headMap[X_scalegray_APIKEY] = authly.APIKey
	headMap[Accept] = application_vnd_scalegray_json
	headMap[X_scalegray_HMAC] = authly.Email + ":" + CalcHMAC(authly.APIKey, (timeStampedPath+"\n"+md5Body))
